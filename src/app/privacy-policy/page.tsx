...
export default function PrivacyPolicyPage() {
  return (
    <Container sx={{ py: 4 }}>
      <Paper sx={{ p: 4 }}>
        <Typography variant="h1" sx={{ mb: 3 }}>Política de Privacidad</Typography>
        
        <Typography variant="body1" sx={{ mb: 3 }}>
          El sitio web ZAG es propiedad de ZAG Chile, que es un controlador de datos de tus datos personales.
          Hemos adoptado esta Política de privacidad, que determina cómo procesamos la información recopilada por ZAG, 
          que también proporciona las razones por las que debemos recopilar ciertos datos personales sobre ti. 
          Por lo tanto, debes leer esta Política de privacidad antes de usar el sitio web de ZAG
        </Typography>
        ...
        <Typography variant="h2" sx={{ mb: 2 }}>Información personal que recopilamos:</Typography>
        <Typography variant="body1" sx={{ mb: 3 }}>
          Cuando visitas ZAG Chile, recopilamos automáticamente cierta información sobre tu dispositivo, 
        ...
        <Typography variant="h2" sx={{ mb: 2 }}>¿Por qué procesamos tus datos?</Typography>
        <Typography variant="body1" sx={{ mb: 3 }}>
          ...
          establecer información estadística sobre el uso del sitio web. Esta información estadística no se agrega 
        ...
        <Typography variant="body1" sx={{ mb: 3 }}>
          ...
          de qué información es obligatoria pueden ponerse en contacto con nosotros a través de contacto@zag.cl
        </Typography>

        <Typography variant="h2" sx={{ mb: 2 }}>Tus derechos:</Typography>
        ...
        <Typography variant="body1" sx={{ mb: 3 }}>
          ...
          que tu información puede transferirse fuera de Europa, incluidos Canadá y Estados Unidos.
        </Typography>

        <Typography variant="h2" sx={{ mb: 2 }}>Enlaces a otros sitios web:</Typography>
        <Typography variant="body1" sx={{ mb: 3 }}>
          ...
          de terceros. Te recomendamos que estés atento cuando abandones nuestro sitio web y leas las declaraciones 
          de privacidad de cada web que pueda recopilar información personal.
        </Typography>

        <Typography variant="h2" sx={{ mb: 2 }}>Seguridad de la información:</Typography>
        <Typography variant="body1" sx={{ mb: 3 }}>
        ...
        <Typography variant="h2" sx={{ mb: 2 }}>Divulgación legal:</Typography>
        <Typography variant="body1" sx={{ mb: 3 }}>
          Divulgaremos cualquier información que recopilemos, usemos o recibamos si así lo requiere o lo permite la ley, 
          como para cumplir con una citación o un proceso legal similar, y cuando creamos de buena fe que la divulgación 
          es necesaria para proteger nuestros derechos, proteger tu seguridad o la seguridad de los demás, investigar 
          el fraude o responder a una solicitud del gobierno.
        </Typography>

        <Typography variant="h2" sx={{ mb: 2 }}>Información de contacto:</Typography>
        <Typography variant="body1" sx={{ mb: 3 }}>
          ...
          un correo electrónico a contacto@zag.cl
        </Typography>
      </Paper>
    </Container>
  );
